...
const Category = () => {
  ...
  const [sort, setSort] = useState<
    "relevance" | "priceAsc" | "priceDesc" | "rating" | "experience"
  >("relevance");
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            {total} services available • Find the right professional for your
            needs
          </p>
        </div>
          ...
          <div className="border rounded-lg p-4 bg-background">
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-2 mt-2">
                <input
                  ...
                  className="w-1/2 px-2 py-1 border border-border rounded-md text-sm"
                />
                <input
                  type="number"
                  value={maxPrice}
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full px-3 py-2 bg-secondary text-secondary-foreground rounded-md text-sm"
              >
                Reset Filters
              </button>
            </div>
                    ...
                    <div className="p-4 pt-10 flex flex-col flex-grow">
                      ...
                      <div className="grid grid-cols-2 gap-3 mb-4 text-xs text-muted-foreground">
                        <div className="flex items-center">
                          ...
                          {gig.response_time || "< 24 hours"}
                        </div>
                        <div className="flex items-center">
                          <Briefcase className="h-3 w-3 mr-1.5" />
                          {gig.experience_years
                            ? `${gig.experience_years}+ years exp`
                            : "Experienced"}
                        </div>
                      </div>
