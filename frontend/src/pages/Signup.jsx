...
//       // Send user data to your backend (make this optional to not block signup)
//       try {
...
//         } else {
//           console.warn("Backend signup failed, but Firebase signup successful");
//         }
//       } catch (backendError) {
//         console.warn("Backend signup error (Firebase signup still successful):", (backendError as Error).message);
//       }
...
//       // Optional: validate with backend (don't block signup if this fails)
//       try {
//         const response = await fetch("http://127.0.0.1:8000/signup", {
//           method: "POST",
//           headers: { 
...
//         } else {
//           console.warn("Backend validation failed, but Google signup still successful");
//         }
//       } catch (backendError) {
//         console.warn("Backend validation error (Google signup still successful):", (backendError as Error).message);
//       }
